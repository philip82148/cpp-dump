...
inline std::string _export_var(bool value, const std::string &, size_t, size_t, bool) {
...
inline std::string _export_var(char value, const std::string &, size_t, size_t, bool) {
