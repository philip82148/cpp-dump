...
template <typename T>
inline constexpr bool is_arithmetic = std::is_arithmetic_v<remove_cref<T>>;

template <typename T>
inline constexpr bool is_string =
    std::is_convertible_v<T, std::string_view> && !std::is_null_pointer_v<remove_cref<T>>;

template <typename T>
inline constexpr bool is_pointer =
    (std::is_pointer_v<remove_cref<T>> && !is_string<T>) || std::is_null_pointer_v<remove_cref<T>>;

template <typename T>
inline constexpr bool is_void_pointer =
    std::is_same_v<remove_cref<T>, void *> || std::is_same_v<remove_cref<T>, const void *> ||
    std::is_null_pointer_v<remove_cref<T>>;
...
template <typename T>
inline constexpr bool is_exportable_object = _is_exportable_object<remove_cref<T>>;
